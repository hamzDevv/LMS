        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div className="flex space-x-2">
              ...
              <Link
                href="/register"
                className="px-4 py-2 text-sm font-medium text-gray-800 bg-white rounded-md hover:bg-gray-100 transition duration-300"
              >
                Register
              </Link>
            </div>
      ...
      <DisclosurePanel className="sm:hidden">
        <div className="space-y-1 px-2 pt-2 pb-3">
          ...
          <div className="pt-2 pb-2 border-t border-gray-700 flex flex-col space-y-2">
            <Link
              href="/login"
              className="px-4 py-2 text-base font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition duration-300 text-center"
            >
              Login
            </Link>
            <Link
              href="/register"
              className="px-4 py-2 text-base font-medium text-gray-800 bg-white rounded-md hover:bg-gray-100 transition duration-300 text-center"
            >
              Register
            </Link>
          </div>
